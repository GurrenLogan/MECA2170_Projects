...
class TriangularMesh:
    ...
    def __init__(self, vertices : List[List[3]], triangles : List[List[3]]):
...
class Vertex:
    def __init__(self, x=0, y=0, z=0, index : int = None, halfedge : Halfedge = None):
        self.x = x
        self.y = y
        self.z = z
        self.index = index
...
class Face:
    def __init__(self, index : int = None, halfedge : Halfedge = None):
        self.index = index
        # halfedge going ccw around this facet.
        self.halfedge = halfedge

class Halfedge:
    def __init__(self, next : Halfedge = None, opposite : Halfedge = None, prev : Halfedge = None, vertex : Vertex = None,facet : Face = None, index : int = None):
